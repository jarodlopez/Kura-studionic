        ...
        <>
            ...
            {!open && (
                <button onClick={openChat} aria-label="Abrir chat"
                    className="chat-neon-btn fixed bottom-6 left-4 z-[100] w-[52px] h-[52px] rounded-full bg-black text-kuraRed border-2 border-kuraRed flex items-center justify-center hover:scale-110 transition-transform">
