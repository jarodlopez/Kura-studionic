...
window.PaymentModule = ({ order, bankAccounts = [], waNumber = '50587091008', onPaid, onCancel }) => {
    ...
    return (
        <div className="w-full max-w-md mx-auto space-y-4">
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-5 rounded-2xl text-center space-y-3">
                <p className="text-zinc-400 text-xs leading-relaxed">¿Prefieres que un agente te ayude a finalizar y validar tu pago?</p>
